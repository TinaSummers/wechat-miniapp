...
Page({
  data: {
    navHeight: 0,
    renderList: [imgModel.clause_privacy1, imgModel.clause_privacy2, imgModel.clause_privacy3, imgModel.clause_privacy4,]
  },
  onLoad() {
    this.setNav();
  },
  ...
  setNav() {
    this.selectComponent('#comp-nav-dynamic').setOptions({
      ...
      titleTextInit: '隐私条款', // 标题文字-初始值
      titleTextRoll: '隐私条款', // 标题文字-滚动值
